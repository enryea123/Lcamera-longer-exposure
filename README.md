...
LCamera was originally written by PkmX, you can find the original app at:
	https://github.com/PkmX/lcamera/

I simply modified some chunks of code to extend the maximum exposure for the Nexus 6P and 5X and you beyond the hardware limit.

For more info, visit my post on xda developers:
	https://forum.xda-developers.com/nexus-5x/themes-apps/apk-lcamera-longer-exposure-shooting-t3516152

The following is the original readme file by PkmX, all credits go to the original developer.
